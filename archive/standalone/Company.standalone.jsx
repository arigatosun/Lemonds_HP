  ...
  return (
    <section className="lm-section" data-screen-label="07 Company">
      ...
      <div className="lm-co-mosaic">
        <div className="m-large" style={{backgroundImage:`url(${window.LM_ASSET('photo-business-meeting.jpg')})`}}>
          <div className="cap"><span className="k">— OFFICE / TOKYO</span><span className="t">想いを、価値あるカタチに。</span></div>
        </div>
        <div className="m-tall" style={{backgroundImage:`url(${window.LM_ASSET('photo-merch-flatlay.jpg')})`}}/>
        <div className="m-mid" style={{backgroundImage:`url(${window.LM_ASSET('photo-cosmetics-mono.jpg')})`}}/>
        <div className="m-mid" style={{backgroundImage:`url(${window.LM_ASSET('photo-concert-lights.jpg')})`}}/>
        <div className="m-wide" style={{backgroundImage:`url(${window.LM_ASSET('photo-friends-selfie.jpg')})`}}/>
      </div>
