      ...
      <div style={{
        ...
        {services.map(s => (
          <div key={s.title} className="lm-svc-card-b">
            <div className="thumb" style={{backgroundImage:`url(${window.LM_ASSET(s.img)})`}}/>
